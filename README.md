...
* Use `npm start` to start local development web server for frontend development with all Firebase emulators active. Needs full database dump as `backup.json` (create by downloading from `/api/data` from production).
